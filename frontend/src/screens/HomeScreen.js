...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    listOfImages = importAll(require.context('C:/Users/dword/Desktop/amazona-master/uploads', false, /\.(png|jpe?g|svg)$/));
  ...
  return (
    ...
    <div >
      ...
      <h1 style={{align:"center",paddingTop:"10px"}}>&nbsp;&nbsp;CATEGORIES</h1>
      ...
      {/* {loadingCategories ? (
            ...
            <tr>
              ...
              <div class="container">
                  ...
                  <img src="images/p12.jpg" height="280px" width="280px" alt="NO"></img>
                  </Link>
              ...
              <div class="container">
                  ...
                  <img src="images/p15.jpg" height="280px" width="280px" alt="NO"></img>
                  </Link>
                    <div  style={{backgroundColor:"#000000",height:"40px",borderRadius:"1px",display:"flex",justifyContent:"center",alignContent:"center"}}>
                     <Link
                          to={`/search/category/Statue`}   
              ...
              <div class="container">
                  ...
                  <img src="images/p11.jpg" height="280px" width="280px" alt="NO"></img>
                  </Link>
                    <div  style={{backgroundColor:"#000000",height:"40px",borderRadius:"1px",display:"flex",justifyContent:"center",alignContent:"center"}}>
                     <Link
                          to={`/search/category/Sticker`}   
            ...
            <tr>
              ...
              <div class="container">
                  <Link
                          to={`/search/category/PoojaItem`} >
                  <img src="images/p13.jpg" height="280px" width="280px" alt="NO"></img>
                  </Link>
                    <div  style={{backgroundColor:"#000000",height:"40px",borderRadius:"1px",display:"flex",justifyContent:"center",alignContent:"center"}}>
                     <Link
                          to={`/search/category/PoojaItem`}   
              ...
              <div class="container">
                  <Link
                          to={`/search/category/Sticker`} >
                  <img src="images/p16.jpg" height="280px" width="280px" alt="NO"></img>
                  </Link>
                    <div  style={{backgroundColor:"#000000",height:"40px",borderRadius:"1px",display:"flex",justifyContent:"center",alignContent:"center"}}>
                     <Link
                          to={`/search/category/Sticker`}   
    ...
    <form action="/api/uploads" onSubmit={submitHandler}>
          ...
          {/* <div>
            ...
            <tr>
              <td>
              <div class="container">
                  <img src="images/p14.jpg" height="280px" width="280px" alt="NO"></img>                    
                </div>
              </td>
              <td>
              <div class="container">
